...
证明参考 [APL1](@plestanNewMethodologiesAdaptive2010.md#APL1)
...
因此可以发现，在 $\sigma _0=\varepsilon ^+\rightarrow \varepsilon$ 时，最大的误差满足 $$\begin{array}{c}
...
![Pasted image 20220216151401.png](paper\assets\Pasted image 20220216151401.png)

参考上面这张例图。图上半部分是滑模变量随着时间变化的图，下半部分是 K 随着时间变化的图。

假定一开始 $\left| \sigma \left( x,t \right) \right|>\varepsilon$，则根据提出的控制器规则，[^eqn-control-law](@plestanNewMethodologiesAdaptive2010.md#^eqn-control-law)，
...
我个人觉得论文论证有点不太严谨，比如 [APL1](@plestanNewMethodologiesAdaptive2010.md#APL1) 部分或许就存在一些问题。
