...
% Date         : 2021-09-03 12:43:29
 % LastEditors  : randolf
 % LastEditTime : 2021-12-08 10:07:58
 % FilePath     : \undefinedd:\Work\Matlab2021\lib\extract-scope\scope_file_extract.m
%%
%! Note: the version suit with 2021a. the function readmatrix is not
%compatible with 2018b

function [nameList, dataList] = scope_file_extract(fileName)
    %% extract signle file
    % IN: fileName
    % OUT:
