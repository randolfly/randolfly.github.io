...
% Date         : 2021-09-03 12:50:12
 % LastEditors  : randolf
 % LastEditTime : 2021-12-08 10:18:19
 % FilePath     : \undefinede:\randolf.top\skill\matlab\attachments\scope_handle_rawdata.m
%%
...
% file src path
function [dataCell] = scope_handle_rawdata()
    ...
    if isequal(file, 0)
        ...
        for index = 1:fileNum
            ...
            [nameList, dataList] = scope_file_extract(fileName);
