...
%%
% InPfOri = [Roll, Pitch, Yaw, X, Y, Z] initial platform (RPY Form)
% position
% 猜测的姿思

InPfOri = [deg2rad(0); deg2rad(20); deg2rad(20); 0; 0; 300];
...
% or use angle2dcm, note the matrix should be transpose, it has a meaning
% of vector space
% Rot = angle2dcm(thz,thy,thx,'ZYX')';
